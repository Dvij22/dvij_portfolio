...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      to_email: 'dvijpandya223@gmail.com',
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:dvijpandya223@gmail.com" className="text-muted hover:text-light transition-colors">
                    dvijpandya223@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/dvij22" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/dvijpandya22" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
